...
if(isset($_GET['id']))
{
    ...
    if(isset($_GET['action']))
    {
        ...
        {
            //query
            $query = "SELECT location from `files` WHERE `id` = '$id' ";
            $result = mysqli_query($dbc, $query)
                or die('Error');
            list($file_path) = mysqli_fetch_array($result);

            //delete the file
            unlink('../' . $file_path);

            //now delte from the db
                                                      ...
                                                      <table class="table table-bordered">
                                                          ...
                                                          $result = mysqli_query($dbc, $query)
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <a href="edit_documents.php?matricule=<?php echo $matricule; ?>&id=<?php echo $row['id']; ?>&action=del"
