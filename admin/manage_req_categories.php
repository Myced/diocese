...
if(isset($_GET['id']))
{
    ...
    {
        //delete the school
        $query = "DELETE FROM `req_categories` WHERE `id` = '$id' ";
                                      ...
                                      $result = mysqli_query($dbc, $query)
                                        ...
                                        <tr>
                                            <td colspan="5" class="text-center">
                                                <strong class="text-primary">No Categories yet</strong>
                                            </td>
                                        </tr>
                                            <?php
                                        }
                                        else
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="edit_req_category.php?id=<?php echo $row['id']; ?>" class="btn btn-xs btn-primary"
                                                        title="Edit">
...
include_once 'includes/scripts.php';
 ...
 <script type="text/javascript">
     $(document).ready(function(){
         var url = "manage_req_categories.php?action=del&id=";
